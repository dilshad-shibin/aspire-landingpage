...
if(isset($_POST['submit']) and !empty($_POST['submit'])){
    ...
    $mail1_subject="ACADEMY OF MEDIA AND DESIGN Enquiry from Google Ads, " . $name;
    $mail1_txt="Name :" . $name . "<br>" . "Mobile :" . $phone . "<br>" . "E-Mail :" . $email . "<br>" . "Location :" . $location . "<br>" . "Source :" . $esource . "<br>" . "Medium :" . $emedium . "<br>" . "IP :" . $ip . "<br>";
    ...
    $apiKey = urlencode('uepOUIcSsXO332fU');
    $utm_id = "5592716816";
    $agent = "25067144";
...
$url = 'http://viralmafia.com/demo/jsonmaileramd.php';
$ch = curl_init($url);
$data = array(
    'to' => $to,
